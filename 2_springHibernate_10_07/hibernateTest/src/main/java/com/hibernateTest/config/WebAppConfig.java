package com.hibernateTest.config;
...
@ComponentScan({"com.hibernateTest"}) //говорит, где искать компоненты проекта.
...
public class WebAppConfig extends WebMvcConfigurerAdapter {
    ...
    //переопределив данный метод мы сможем указать где будут лежать ресурсы нашего проекта, такие как css, images, js и другие.
    @Override
